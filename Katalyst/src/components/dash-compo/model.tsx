...
export default function AnthropicCards() {
  return (
    <div className="bg-[#f0eee6] flex items-center justify-center p-4">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12 px-4 md:px-8 w-full max-w-7xl">
        {/* Card 1 - Core Views on AI Safety */}
        <div className="bg-[#e5ddd1] rounded-3xl p-6 md:p-12 flex flex-col items-start justify-between">
          <div className="flex-1 flex items-center justify-center w-full group">
            <svg viewBox="0 0 200 200" className="w-40 sm:w-48 md:w-56 lg:w-64 h-auto transition-transform duration-300 group-hover:scale-110">
        ...
        <div className="bg-[#b8d4d1] rounded-3xl p-6 md:p-12 flex flex-col items-start justify-center">
          <div className="flex-1 flex items-center justify-center w-full group">
            <svg viewBox="0 0 200 200" className="w-40 sm:w-48 md:w-56 lg:w-64 h-auto transition-transform duration-300 group-hover:scale-110">
        ...
        <div className="bg-[#c8cce5] rounded-3xl p-6 md:p-12 flex flex-col items-start justify-between">
          <div className="flex-1 flex items-center justify-center w-full group ">
            <svg viewBox="0 0 200 200" className="w-40 sm:w-48 md:w-56 lg:w-64 h-auto transition-transform duration-300 group-hover:scale-110">

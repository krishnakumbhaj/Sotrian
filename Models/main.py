...
# For deployment: set FRONTEND_URL env var to your Vercel URL
#   e.g. FRONTEND_URL=https://sotrian.vercel.app
#   Supports comma-separated values: https://sotrian.vercel.app,https://custom-domain.com
...
# Parse comma-separated production origins from FRONTEND_URL
if frontend_origin:
...
# Auto-allow all Vercel preview/deployment URLs (*.vercel.app)
vercel_regex = r"https://.*\.vercel\.app"

print(f"🌐 CORS allowed origins: {allow_origins}")
print(f"🌐 CORS origin regex (Vercel): {vercel_regex}")
...
def get_default_models_path() -> str:
    ...
    # Prefer explicit environment variable. If not set, use the Models directory
    # relative to this file so the project works out-of-the-box in this repo.
    env_path = os.getenv('MODELS_PATH')
    if env_path:
        return env_path

    # Default to the 'Models' directory where this file lives

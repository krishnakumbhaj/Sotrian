          ...
          <div className="flex justify-between items-center h-24">
            ...
            <div className="flex items-center space-x-1 flex-shrink-0">
              <div className="w-12 h-12 rounded-lg flex items-center justify-center">
                ...
                <div ref={logoNameRef} className="overflow-hidden hidden sm:block">
                  <Image
                    src={Logo_image}
                    alt="Katalyst"
                    width={140}
            ...
            <div className="flex items-center space-x-6">
              ...
              <div className="hidden md:flex items-center space-x-6">
                <button
                  ...
                  className="text-zinc-950 hover:text-zinc-800 transition-colors duration-200 text-base md:text-2xl focus:outline-none"
                >
                  Features
                </button>
                <button 
              ...
              <div className="hidden md:flex items-center bg-teal-800 rounded-2xl">
                <Link
                  href="/Sotrian.ai"
                  className="px-4 py-3 flex items-center space-x-1 text-white text-sm md:text-lg font-medium hover:bg-teal-900 hover:rounded-l-2xl transition-colors duration-200 focus:outline-none rounded-l-2xl"
                >
...
<section ref={heroRef} className="min-h-[calc(100vh-120px)] px-4 flex items-center">
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12 items-center">
      ...
      {/* <div className="flex justify-center items-center"> */}
        <div
          ref={containerRef}
          className="w-full h-64 sm:h-80 md:h-96 lg:h-[500px] bg-[#f0eee6] rounded-3xl"
    ...
    {/* </div> */}
      ...
      {/* Features Overview */}
  <section className="py-16 px-4 bg-[#f0eee6]">
      <div className="mx-auto max-w-7xl">
        <div className="bg-[#e3dacc] rounded-3xl p-6 md:p-12">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-10 items-baseline">
            {/* Left Content */}
            <div>
              ...
              >
                <span className="text-base sm:text-lg md:text-xl font-medium text-gray-900">
                  Managing context on the Sotrian Developer Platform
                               ...
                               <ArrowRight className="w-6 h-6 sm:w-8 sm:h-8 text-gray-900 group-hover:translate-x-1 transition-transform duration-300" />
